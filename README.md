...
Prerequisite for the cinder proposal are to be applied in the following order HAProxy, Percona and RabbitMQ. Cinder proposal as usual needs to be created and saved with the correct attributes. The primary configuration for the cinder proposal is the volume type and the maximum file size. 
